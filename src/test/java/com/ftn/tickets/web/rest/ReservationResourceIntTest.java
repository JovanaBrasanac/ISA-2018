...
public class ReservationResourceIntTest {
    ...
    public static Reservation createEntity(EntityManager em) {
        ...
        em.flush();
        reservation.setReservingUser(userExtra);
        return reservation;
    }
    ...
    public void createReservation() throws Exception {
        ...
        assertThat(testReservation.getNumberOfSeats()).isEqualTo(DEFAULT_NUMBER_OF_SEATS);
    }
    ...
    public void updateReservation() throws Exception {
        ...
        Reservation testReservation = reservationList.get(reservationList.size() - 1);
        assertThat(testReservation.getNumberOfSeats()).isEqualTo(UPDATED_NUMBER_OF_SEATS);
    }
